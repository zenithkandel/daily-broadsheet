...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=DM+Sans:wght@400;500;700&family=Lora:wght@400;500;600&display=swap"
        rel="stylesheet">
    ...
    <div class="main-container">
        ...
        <?php if ($featured): ?>
            <section class="hero-section">
                ...
                <div class="hero-content">
                    ...
                    <h1><a
                            href="index.php?page=article&id=<?= $featured['id'] ?>"><?= htmlspecialchars($featured['title']) ?></a>
                    </h1>
        ...
        <main class="content-wrapper">
                    ...
                    <?php foreach ($recent as $article): ?>
                        <article class="article-card">
                            ...
                            <div class="card-content">
                                <span
                                    class="card-category"><?= getCategoryName($article['category_id'], $categories) ?></span>
                                <h3><a
                                        href="index.php?page=article&id=<?= $article['id'] ?>"><?= htmlspecialchars($article['title']) ?></a>
                                </h3>
            ...
            <aside class="sidebar-left">
                ...
                <ul class="trending-list">
                    <?php foreach ($trending as $i => $item): ?>
                        <li class="trending-item">
                            ...
                            <a
                                href="index.php?page=article&id=<?= $item['id'] ?>"><?= htmlspecialchars($item['title']) ?></a>
                        </li>
                    <?php endforeach; ?>
                ...
                <?php if (adsEnabled()): ?>
                    <div
                        style="margin-top: 3rem; background: var(--paper-dark); padding: 2rem; border: 1px solid var(--rule); text-align: center; color: var(--ink-faded); font-family: 'DM Sans', sans-serif; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 2px;">
                        Advertisement
                    </div>
                <?php endif; ?>
            </aside>
